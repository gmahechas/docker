...
$MONGODB_CMD --eval 'rs.initiate({_id: "rs0", members: [{_id: 0, host: "mongodb1.gmahechas.local:27017", priority: 2}, {_id: 1, host: "mongodb2.gmahechas.local:28017", priority: 1}, {_id: 2, host: "mongodb3.gmahechas.local:29017", priority: 1}]});'
